...
function M.set_snapshot(bufnr, payload)
	...
	vim.b[bufnr].marimo_app_options = payload.app_options or {}
	...
	vim.b[bufnr].marimo_runtime_cells = vim.b[bufnr].marimo_runtime_cells or {}
end
